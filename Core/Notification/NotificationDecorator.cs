...
public static class Notification
{
    ...
    public static void NotifySuccess(this object? _, string message, bool autoClose = true, int duration = 2000)
    {
        NotifySuccess(message, autoClose, duration);
    }
    ...
    /// <param name="duration">持续时间-默认2s</param>
    // ReSharper disable once InvalidXmlDocComment
    public static void NotifyInfo(this object? _, string message, bool autoClose = true, int duration = 2000)
    {
        NotifyInfo(message, autoClose, duration);
    }
    ...
    // ReSharper disable once InvalidXmlDocComment
    public static void NotifyWarning(this object? _, string message, bool autoClose = true, int duration = 3000)
    {
        NotifyWarning(message, autoClose, duration);
    }
    ...
    /// <param name="duration">持续时间-默认3s</param>
    // ReSharper disable once InvalidXmlDocComment
    public static void NotifyError(this object? _, string message, bool autoClose = true, int duration = 3000)
    {
        NotifyError(message, autoClose, duration);
    }
